...
/**
 * At the time of the generation of this exercise, redux-persist did not have the type definition
 * for v5 (which I have generated here and submitted back as a pull request).
 * 
 * Hopefully, you (reader or future Rod) do not need to do this again as this file should be included
 * standard with redux-persist.
 */
